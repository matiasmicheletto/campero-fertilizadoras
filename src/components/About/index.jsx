            ...
            <List accordionList>
                <ListItem accordionItem title="Versión de la aplicación">
                    <AccordionContent>
                        <Block>
                            <center>
                                    <h3>CAMPERO FERTILIZADORAS 1.1</h3>
                            </center>
                            <h3>Staff</h3>
                ...
                <ListItem accordionItem title="Términos y condiciones">
                    <AccordionContent>
                        ...
                        <p><i>Aceptación de los términos y condiciones</i></p>
                            <p style={{textAlign:"justify"}}>Al acceder o utilizar los servicios de CAMPERO, el usuario acepta los términos y condiciones establecidos a continuación.</p>
